    ...
    private val resultMapper =
            { rs: ResultSet ->
                Troll(
                        ...
                        rs.getBoolean("is_glitter"),
                        LocalDateTime.ofInstant(rs.getDate("created_at").toInstant(), ZoneOffset.UTC),
                        LocalDateTime.ofInstant(rs.getDate("updated_at").toInstant(), ZoneOffset.UTC)
                )
            }
    ...
    override fun insert(input: TrollData): Long =
            jdbi.withHandleUnchecked { handle ->
                handle
                        .createUpdate(
                                """
                                    insert into $tableName (name, description, is_glitter)
